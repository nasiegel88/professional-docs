...
\begin{rSubsection}{General Dynamics Information Technology}{Dec 23 - present}{Senior Data Analyst}{}

\item Organizing data analysis projects for the Navy
\item Assessment of pathogen virulence factors
\item Building whole genome sequencing pipelines

\end{rSubsection}

%------------------------------------------------

\begin{rSubsection}{UC Davis}{Apr 18 - Dec 23}{Graduate Student Researcher}{}

\item Conducted gut and lung microbiome analysis in the rhesus monkey model
\item Characterized the metabolic profile of the infant rhesus monkey gut microbiome
\item Developed workflows for transcriptomic analysis
